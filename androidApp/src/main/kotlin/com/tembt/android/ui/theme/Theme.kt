...
val PumpkinSpice  = Color(0xFFFC7A1E)
val MoltenOrange  = Color(0xFFF24C00)
val DuskBlue      = Color(0xFF485696)
val ApricotCream  = Color(0xFFF9C784)
val AlabasterGrey = Color(0xFFE7E7E7)
val TembtBlack    = Color(0xFF1A1A1A)
